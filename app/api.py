...
@api_application.route("/calc/product/<op_1>/<op_2>", methods=["GET"])
def product(op_1, op_2):
    try:
        num_1, num_2 = util.convert_to_number(op_1), util.convert_to_number(op_2)
...
@api_application.route("/calc/division/<op_1>/<op_2>", methods=["GET"])
def division(op_1, op_2):
    try:
        num_1, num_2 = util.convert_to_number(op_1), util.convert_to_number(op_2)
